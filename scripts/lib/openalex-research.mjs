export const allowedCategories = new Set([
  ...
  'youtube',
  'podcast',
  // Used by the wave configs but missing here until 2026-08-08, so every occupation under
  // them was silently filed as thought-leadership — including the creator, streaming, and
  // media groups that a creator-led launch most wants to sort by.
  'digital-creator',
  'streaming',
  'blogging',
  'media',
